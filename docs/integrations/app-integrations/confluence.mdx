...
Using Personal Access Token Note: this method is valid for Jira and Confluence (<7.9) Data center / server editions only! For >7.9, username/password must be used instead of personal access token.
</Tip>
